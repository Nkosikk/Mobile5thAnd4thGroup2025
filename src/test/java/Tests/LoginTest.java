...
public class LoginTest extends BaseTest {
    ...
    public void LoginWithValidCredentials() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the menu is fully loaded before taking a screenshot
    ...
    public void verifyLoginSuccess() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the welcome message is fully loaded before taking a screenshot
    ...
    public void verifyAdminPanelAccess() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the admin panel is fully loaded before taking a screenshot
    ...
    public void verifyAdminDashboard() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the admin dashboard title is fully loaded before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Admin Dashboard Displayed");
        adminPage.clickAdminBurgerMenu();
        Thread.sleep(2000);
        // Adding a short wait to ensure the admin panel title is fully loaded before taking a screenshot
    ...
    public void createCourse() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the create course form is fully loaded before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Create Course Form Displayed");
        coursePage.enterCourseTitle("Test Course Title");
        Thread.sleep(2000);
        // Adding a short wait to ensure the course title is entered before taking a screenshot
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the description is entered before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Course Description Entered");
        coursePage.enterDuration("60");
        Thread.sleep(2000);
        // Adding a short wait to ensure the duration is entered before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Course Duration Entered");
        coursePage.selectLevel("Intermediate");
        Thread.sleep(2000);
        // Adding a short wait to ensure the level is selected before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Course Level Selected");
        coursePage.enterPrice("600");
        Thread.sleep(2000);
        // Adding a short wait to ensure the price is entered before taking a screenshot
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the published checkbox is set before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Course Published Checkbox Set");
        coursePage.clickCreateCourseButton();
        Thread.sleep(2000);
        // Adding a short wait to ensure the course creation is submitted before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Create Course Button Clicked");
        /*coursePage.clickCancelButton();
        Thread.sleep(2000);
        // Adding a short wait to ensure the cancel action is completed before taking a screenshot
    ...
    public void verifyCourseCreation() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the manage courses title is fully loaded before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Manage Courses Title Displayed");
        manageCoursePage.verifyCourseDetails();
        Thread.sleep(2000);
        // Adding a short wait to ensure the course details are fully loaded before taking a screenshot
        ScreenshotUtils.captureScreenshot(driver, "Course Details Verified in Manage Courses");
        manageCoursePage.clickEditCourseButton();
        Thread.sleep(2000);
        // Adding a short wait to ensure the edit course form is fully loaded before taking a screenshot
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the save course action is completed before taking a screenshot
        ...
        Thread.sleep(2000);
        // Adding a short wait to ensure the logout action is completed before taking a screenshot
